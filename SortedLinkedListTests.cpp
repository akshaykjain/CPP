...
void test_string()
{
    ...
    const string INSERT[] = {"science", "math", "physics", "chemistry", "english", "history", "tennis"};
    const int INSERT_LENGTH = sizeof(INSERT)/sizeof(INSERT[0]);
    for (int i = 0; i < INSERT_LENGTH; i++) 
	{
    ...
    const string REMOVE[] = {"science", "history", "tennis", "chemistry", "math", "history", "physics", "art", "english"};
    const int REMOVE_LENGTH = sizeof(REMOVE)/sizeof(REMOVE[0]);
    for (int i = 0; i < REMOVE_LENGTH; i++)
    {
